...
public class PersonControllerJsonTest extends AbstractIntegrationTest {
  ...
  public void testFindAll() throws JsonMappingException, JsonProcessingException {
    ...
    assertEquals("Thiago", foundPersonOne.getFirstName());
    assertEquals("Gritti", foundPersonOne.getLastName());
    assertEquals("Balneário Camboriú - Santa Catarina - Brasil", foundPersonOne.getAddress());
